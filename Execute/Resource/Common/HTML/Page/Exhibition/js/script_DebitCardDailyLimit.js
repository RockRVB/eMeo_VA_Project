...
function bsStyle() {
 ...
 $("select[name=CashWithdrawalLimit], select[name=ThirdPartyTransfer], select[name=NETSLimit], select[name=FundsTransferLimit]").selectpicker({
		//size: 11  
	}); 
 $("select[name=DebitCardDailyLimit]").selectpicker({
		width:270
	}); 
}
