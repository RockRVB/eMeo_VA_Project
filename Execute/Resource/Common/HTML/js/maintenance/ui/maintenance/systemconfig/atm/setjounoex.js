	...
	function InvokeChildrenSwitch(){
		...
		function removeValueDataNNumber(){
				document.getElementById('INPUT_SERAL_NUM').style.backgroundColor="";
				document.getElementById('INPUT_SERAL_NUM').blur();
		}
		function setSerialNo(){
				document.getElementById('INPUT_SERAL_NUM').style.backgroundColor="#FFFACD";
				document.getElementById('INPUT_SERAL_NUM').click();	
