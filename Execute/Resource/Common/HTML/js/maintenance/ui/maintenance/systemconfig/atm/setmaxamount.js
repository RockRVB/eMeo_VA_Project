ChildrenFlag=0;
	function InvokeChildrenSwitch(){
		...
		function removeValueDataNNumber(){
				document.getElementById('INPUT_MAXAMTOFWITHDRAW').style.backgroundColor="";
				document.getElementById('INPUT_MAXAMTOFTRANSFER').style.backgroundColor="";
				document.getElementById('INPUT_MAXAMTOFWITHDRAW').blur();
				document.getElementById('INPUT_MAXAMTOFTRANSFER').blur();
		}
		function setMaxWithdraw(){
				document.getElementById('INPUT_MAXAMTOFWITHDRAW').style.backgroundColor="#FFFACD";
				document.getElementById('INPUT_MAXAMTOFWITHDRAW').click();	
		
		}
		function setMaxTransfer(){
				document.getElementById('INPUT_MAXAMTOFTRANSFER').style.backgroundColor="#FFFACD";
				document.getElementById('INPUT_MAXAMTOFTRANSFER').click();
		}
