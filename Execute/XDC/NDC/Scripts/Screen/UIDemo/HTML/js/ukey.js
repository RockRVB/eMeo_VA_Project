...
require(['config/config','main'],function(){
	require(['jquery','checkClass','inputClass'],function($,check,ins){
		function getTxtCursorPosition(){
            var oTxt1 = document.getElementById("InputUKeyActivationCode");
...
//              range.select();
		...
		$(function(){
			...
			$("#InputUKeyActivationCode").on("input propertychange",function(){
				...
				if(ins.slideShow("Execute","标准英语键盘","Move","VER",$(window).height(),$(window).height()-500*bits,0.6,$(this))){
