...
//聚焦交易流水号输入框
function setFocusTransSerialNumbers()
{
	document.getElementById('INPUT_JOU_SERIALNO').style.backgroundColor="#FFFACD";
	document.getElementById('INPUT_JOU_SERIALNO').click();
}

//去掉聚焦
function removeValueDataNNumber()
{
	document.getElementById('INPUT_JOU_SERIALNO').style.backgroundColor="";
	document.getElementById('INPUT_JOU_SERIALNO').blur();
};
