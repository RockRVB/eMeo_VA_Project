ChildrenFlag=0;
	function InvokeChildrenSwitch(){
		...
		function removeValueDataNNumber(){
				document.getElementById('INPUT_SERIALNO').style.backgroundColor="";
				document.getElementById('INPUT_SERIALNO').blur();
		}
		function setSerialNo(){
				document.getElementById('INPUT_SERIALNO').style.backgroundColor="#FFFACD";
				document.getElementById('INPUT_SERIALNO').click();	
