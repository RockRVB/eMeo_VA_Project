...
window['EN'] = {
    start: {
        clickStart: 'Click the button to start cardless transactions',
        insertCard: 'Please Insert Yout Card',
		or: 'or',
		touchScreen: 'touch the screen to begin',
    },
    BioTrans: {
...
window['CN'] = {
    start: {
        clickStart: '点击按钮开始无卡交易',
        insertCard: '请插入卡',
		or: '或',
        touchScreen: '触摸屏幕开始操作',
    },
    BioTrans: {
        title: '请选择项目',
