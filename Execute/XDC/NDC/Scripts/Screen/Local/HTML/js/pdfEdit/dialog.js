...
(function ($) {
    ...
    $.dialog.prototype = {
        ...
        _bindEvents: function () { // bind events
            ...
            this.element.delegate('.clear', 'click', function () {
                self._clear(self.options.onClear);
            });
        ...
        _build: function (html) { // build the template for dialog
            ...
            if (html) {
                ...
                if (this.options.confirmBtn) {
                    //tag="OnSignConfirm"
                    cfBtn = '<button class="confirm" tag="OnSignConfirm" id="_pdfsign_dialog_confirmBtn" type="Button">' + this.options.confirmText + '</button>';
                }

                if (this.options.cannelBtn) {
                    clBtn = '<button class="cannel">' + this.options.cannelText + '</button>';
                }
                var clearBtn = '<button class="clear">' + this.options.clearText + '</button>'; ;
                ...
                //<div class="CounterDiv" style="display: none" id="CounterEx" type="countdown" content="{Binding Count}"></div>\
