...
{
    [GrgActivity("{365941D1-5D2A-4623-9E99-7E5EEE66CAA5}",
                     Name = "VAB_AskPrintReceiptCWD",
                     NodeNameOfConfiguration = "VAB_AskPrintReceiptCWD",
                     Author = "rocky",
                     ForwardTargets = new string[] { EventDictionary.s_EventConfirm, EventDictionary.s_EventFail, EventDictionary.s_EventCancel })]
    public class VAB_AskPrintReceiptCWD : IBankProjectActivityBase
    {
        ...
        {
            return new VAB_AskPrintReceiptCWD();
        }
        #endregion
