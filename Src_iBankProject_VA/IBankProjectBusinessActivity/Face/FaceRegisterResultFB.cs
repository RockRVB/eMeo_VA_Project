...
{
    [GrgActivity("{C50D187A-3FA4-488E-B138-5EA4C3F4437B}",
                 NodeNameOfConfiguration = "FaceRegisterResultFB",
                 Name = "FaceRegisterResultFB",
                 Author = "")]
    public class FaceRegisterResultFB : IBankProjectActivityBase
    {
        #region creating
        [GrgCreateFunction("Create")]
        public static IBusinessActivity Create()
        {
            return new FaceRegisterResultFB() as IBusinessActivity;
        }
        #endregion

        #region constructor
        protected FaceRegisterResultFB()
        {
        ...
        protected override emBusActivityResult_t InnerRun(BusinessContext objContext)
        {
            ...
            {
                Log.Action.LogError("FaceRegisterResult data is null or empty. unpack fail.");
            ...
            //Log.Action.LogDebugFormat("FaceRegisterResult data is:{0}", strData);
