...
{
    [GrgActivity("{AF4417E0-EF7E-4256-A058-5077EA243B24}",
                 NodeNameOfConfiguration = "FingerveinDeleteResultFB",
                 Name = "FingerveinDeleteResultFB",
                 Author = "")]
    public class FingerveinDeleteResultFB : IBankProjectActivityBase
    {
        #region creating
        [GrgCreateFunction("Create")]
        public static IBusinessActivity Create()
        {
            return new FingerveinDeleteResultFB() as IBusinessActivity;
        }
        #endregion

        #region constructor
        protected FingerveinDeleteResultFB()
        {
        ...
        protected override emBusActivityResult_t InnerRun(BusinessContext objContext)
        {
            ...
            {
                Log.Action.LogError("FingerveinDeleteResultFB data is null or empty. unpack fail.");
            ...
            //Log.Action.LogDebugFormat("FingerveinDeleteResultFB data is:{0}", strData);
