...
{
    [GrgActivity("{B591CC1F-347F-4307-B9CD-22207EABCF05}",
                 NodeNameOfConfiguration = "FingerveinRegisterResultFB",
                 Name = "FingerveinRegisterResultFB",
                 Author = "")]
    public class FingerveinRegisterResultFB : IBankProjectActivityBase
    {
        #region creating
        [GrgCreateFunction("Create")]
        public static IBusinessActivity Create()
        {
            return new FingerveinRegisterResultFB() as IBusinessActivity;
        }
        #endregion

        #region constructor
        protected FingerveinRegisterResultFB()
        {
        ...
        protected override emBusActivityResult_t InnerRun(BusinessContext objContext)
        {
            ...
            {
                Log.Action.LogError("FingerveinRegisterResult data is null or empty. unpack fail.");
            ...
            //Log.Action.LogDebugFormat("FingerveinRegisterResult data is:{0}", strData);
