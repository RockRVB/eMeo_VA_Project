...
namespace VTMBusinessActivity
{
    [GrgActivity("{A937DEDE-5CC7-4912-9DBA-95F472AACDC6}",
             NodeNameOfConfiguration = "InputPassportInfoMess",
             Name = "InputPassportInfoMess")]
    public class InputPassportInfoMess : BusinessActivityVTMBase
    {
        #region properties
        ...
        {
            return new InputPassportInfoMess() as IBusinessActivity;
        }
        #endregion

        #region constructor
        protected InputPassportInfoMess()
        {
        }
        #endregion
